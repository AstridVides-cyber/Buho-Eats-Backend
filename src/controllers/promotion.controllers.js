...
export const getPromotionsController = async (req, res, next) => {
    ...
    try {
        ...
        if (!promotions) throw new createError(404, "No se encontraron promociones para este restaurante");
...
export const getPromotionByIdController = async (req, res, next) => {
    ...
    try {
        ...
        if (!promotion) throw new createError(404, "No se encontró la promoción");
